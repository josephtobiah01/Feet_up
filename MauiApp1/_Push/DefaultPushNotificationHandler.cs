...
namespace Plugin.FirebasePushNotification
{
    public class MyPushNotificationHandler : IPushNotificationHandler
    {
       ...
       //         return;
            ...
            var resultIntent = typeof(Activity).IsAssignableFrom(
                FirebasePushNotificationManager.NotificationActivityType) ? 
                        ...
                        foreach (var action in userCat.Actions)
                        {
                            ...
                            if (userCat.Category.Equals(category, StringComparison.CurrentCultureIgnoreCase))
                            {
                                ...
                                if (action.Type == NotificationActionType.Foreground)
                                {
                                    ...
                                    actionIntent = typeof(Activity)
                                        .IsAssignableFrom(FirebasePushNotificationManager.NotificationActivityType) ?
                                                        new Intent(Application.Context, FirebasePushNotificationManager.NotificationActivityType) 
                                                         : context.PackageManager.GetLaunchIntentForPackage(context.PackageName);

...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Shiny.AndroidActivityLifecycle, Shiny.Core", AndroidActivityLifecycle.class, __md_methods);
	}


	public AndroidActivityLifecycle ()
	{
		super ();
		if (getClass () == AndroidActivityLifecycle.class) {
			mono.android.TypeManager.Activate ("Shiny.AndroidActivityLifecycle, Shiny.Core", "", this, new java.lang.Object[] {  });
		}
	}

	public AndroidActivityLifecycle (android.app.Application p0)
	{
		super ();
		if (getClass () == AndroidActivityLifecycle.class) {
			mono.android.TypeManager.Activate ("Shiny.AndroidActivityLifecycle, Shiny.Core", "Android.App.Application, Mono.Android", this, new java.lang.Object[] { p0 });
		}
	}

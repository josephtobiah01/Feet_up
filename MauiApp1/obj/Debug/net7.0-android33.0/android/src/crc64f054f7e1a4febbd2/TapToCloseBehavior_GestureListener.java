...
public class TapToCloseBehavior_GestureListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Maui.FixesAndWorkarounds.TapToCloseBehavior+GestureListener, PureWeen.Maui.FixesAndWorkarounds", TapToCloseBehavior_GestureListener.class, __md_methods);
	}


	public TapToCloseBehavior_GestureListener ()
	{
		super ();
		if (getClass () == TapToCloseBehavior_GestureListener.class) {
			mono.android.TypeManager.Activate ("Maui.FixesAndWorkarounds.TapToCloseBehavior+GestureListener, PureWeen.Maui.FixesAndWorkarounds", "", this, new java.lang.Object[] {  });
		}
	}

...
window.JavaScriptInteropDatepicker = function () {
    ...
    $("#datepickerInput").datepicker("option", "showAnim", "fadeIn");

}
function HideExerciseDetail() {
    var sheet = document.getElementById("sheet");
    var blackcover = document.getElementById("BlackCoverDiv");
...
function ShowExerciseDetail() {
    ...
    sheet.style.height = "495px";
    blackcover.hidden = false;
    sheet.hidden = false;
}
    ...
    dragable: function () {
        ...
        function dragElement(elmnt) {
            ...
            function elementDrag(e) {
                ...
                var maxSheetDragHeight = (window.innerHeight -60);
                ...
                if (sheetHeight >= maxSheetDragHeight*.80) {

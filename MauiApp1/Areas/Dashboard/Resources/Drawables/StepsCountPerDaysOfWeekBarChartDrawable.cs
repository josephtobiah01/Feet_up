...
{
    public class StepsCountPerDaysOfWeekBarChartDrawable : IDrawable
    {
        #region [Fields]
        ...
        public List<StepsCountDataPointViewItem> StepsCountDataPointViewItems { get; set; }
        ...
        private double GetXAxisMaxValue()
        {
            ...
            if (this.StepsCountDataPointViewItems != null && this.StepsCountDataPointViewItems.Count > 0)
            {
                barItemHighestValue = this.StepsCountDataPointViewItems.OrderByDescending(t => t.Steps).FirstOrDefault().Steps.Value;
            }
        ...
        private void GenerateBars(ICanvas canvas, RectF dirtyRect)
        {
            ...
            {
                StepsCountDataPointViewItem stepsCount = null;
                ...
                stepsCount = this.StepsCountDataPointViewItems.Where(t => t.LocalEndDateTimeOffset.Date == category.Date).FirstOrDefault();
            
                if (stepsCount != null)
                {
                    double percentageValue = xAxisTotalInterval / _xAxisMaxValue * stepsCount.Steps.Value;
